...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.facebook.key = "#{ENV["FACEBOOK_OAUTH_ID"]}"
  config.facebook.secret = "#{ENV["FACEBOOK_OAUTH_SECRET_KEY"]}"
  ...
  #
  config.google.key = "#{ENV["GOOGLE_OAUTH_ID"]}"
  config.google.secret = "#{ENV["GOOGLE_OAUTH_SECRET_KEY"]}"
